...
class PopularView(context: Context) : LinearLayout(context) {
    ...
    private val popularRecyclerView = RecyclerView(context).apply {
    ...
    init {
        ...
        addView(
            popularRecyclerView, LayoutParams(
    ...
    fun bindData(products:List<Product>){
        popularAdapter.bindData(products)
    }
}